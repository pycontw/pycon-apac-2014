...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalModel.slide_link'
        db.add_column(u'proposal_proposalmodel', 'slide_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProposalModel.video_link'
        db.add_column(u'proposal_proposalmodel', 'video_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProposalModel.slide_link'
        db.delete_column(u'proposal_proposalmodel', 'slide_link')

        # Deleting field 'ProposalModel.video_link'
        db.delete_column(u'proposal_proposalmodel', 'video_link')
    ...
    models = {
        ...
        u'proposal.proposalmodel': {
            ...
            'slide_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
