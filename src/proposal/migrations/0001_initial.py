...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProposalModel'
        db.create_table(u'proposal_proposalmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('speech_type', self.gf('django.db.models.fields.IntegerField')()),
            ('language', self.gf('django.db.models.fields.IntegerField')()),
            ('audience_level', self.gf('django.db.models.fields.IntegerField')()),
            ('talk_perm', self.gf('django.db.models.fields.IntegerField')()),
            ('slide_perm', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'proposal', ['ProposalModel'])

        # Adding model 'AbstractFile'
        db.create_table(u'proposal_abstractfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposal', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['proposal.ProposalModel'], unique=True)),
            ('abstract', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'proposal', ['AbstractFile'])


    def backwards(self, orm):
        # Deleting model 'ProposalModel'
        db.delete_table(u'proposal_proposalmodel')

        # Deleting model 'AbstractFile'
        db.delete_table(u'proposal_abstractfile')
    ...
    models = {
        ...
        u'proposal.abstractfile': {
            'Meta': {'object_name': 'AbstractFile'},
            'abstract': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposal': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['proposal.ProposalModel']", 'unique': 'True'})
        },
        u'proposal.proposalmodel': {
            ...
            'slide_perm': ('django.db.models.fields.IntegerField', [], {}),
