...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProposalModel.slide_perm'
        db.alter_column(u'proposal_proposalmodel', 'slide_perm', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProposalModel.slide_perm'
        db.alter_column(u'proposal_proposalmodel', 'slide_perm', self.gf('django.db.models.fields.IntegerField')(default=None))
