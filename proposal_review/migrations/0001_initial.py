...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReviewRecordModel'
        db.create_table(u'proposal_review_reviewrecordmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['proposal.ProposalModel'])),
        ...
        db.send_create_signal(u'proposal_review', ['ReviewRecordModel'])


    def backwards(self, orm):
        # Deleting model 'ReviewRecordModel'
        db.delete_table(u'proposal_review_reviewrecordmodel')
